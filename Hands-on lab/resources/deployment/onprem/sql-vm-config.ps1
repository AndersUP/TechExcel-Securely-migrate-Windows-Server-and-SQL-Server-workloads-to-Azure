...
Node "localhost"
  {
    Script ConfigureSql
    {
		...
		$dbsource = "https://github.com/andersup/TechExcel-Securely-migrate-Windows-Server-and-SQL-Server-workloads-to-Azure/raw/main/Hands-on%20lab/resources/deployment/onprem/database.bak"
